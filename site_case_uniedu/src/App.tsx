      ...
      <section id="pesquisa" className="py-24 max-w-7xl mx-auto px-6 relative transition-all duration-300">
        ...
        <div className="space-y-16">
          ...
          <div className="grid md:grid-cols-12 gap-8 items-start border-b border-border pb-12">
            ...
            <div className="md:col-span-8 bg-surface border border-border p-6 rounded-2xl space-y-4">
              <p className="text-xs text-text-secondary leading-relaxed">
      ...
      <section id="estrategia" className="py-24 bg-surface/20 border-y border-border transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            {/* HEART Framework */}
            <div className="bg-gradient-to-br from-surface to-surface-elevated border border-border rounded-3xl p-6 md:p-8 relative overflow-hidden transition-all duration-300 shadow-md">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="bg-surface border border-border p-5 rounded-2xl space-y-2 hover:border-brand-soft/30 transition-all duration-300">
                ...
                <h4 className="font-bold text-sm text-text-primary">Fazer Anotações</h4>
                <p className="text-xs text-text-secondary leading-relaxed">
                  Adoção imediata e natural do bloco de notas integrado abaixo do player de vídeo.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <p className="text-xs text-text-secondary mt-1">
              Desenvolvimento e Design Estratégico por Lucas Cabral & Najme Simón Alé
            </p>
          </div>
