export default function ToolMarquee() {
  const tools = [
    ...
    { name: "Vercel", initial: "Ve", desc: "Deploy & Hospedagem" },
    { name: "React", initial: "Re", desc: "Biblioteca de Interface" },
    { name: "Vite", initial: "Vi", desc: "Build Tool" },
    { name: "Tailwind CSS", initial: "Tw", desc: "Estilização Utilitária" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
          {tools.map((tool) => (
            <div
              key={tool.name}
              className="flex items-center gap-3 px-4 py-3.5 rounded-2xl bg-surface border border-border/80 hover:border-brand-soft/40 transition-all duration-300 select-none hover:shadow-md hover:shadow-brand/5"
            >
